...
class DeductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deduction" do
    assert_difference('Deduction.count') do
      post deductions_url, params: { deduction: { amount: @deduction.amount, category: @deduction.category, description: @deduction.description, expense: @deduction.expense } }
    end
  ...
  test "should update deduction" do
    patch deduction_url(@deduction), params: { deduction: { amount: @deduction.amount, category: @deduction.category, description: @deduction.description, expense: @deduction.expense } }
